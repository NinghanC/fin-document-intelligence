...
The public prototype uses neutral GraphRAG source weights by default. Non-uniform weights should be introduced only after evaluation on a labeled retrieval set. Community summaries are precomputed and cached from graph components during ingestion/update rather than generated by an LLM on every query.
